...
node_worker_threads_1.parentPort === null ||
node_worker_threads_1.parentPort === void 0
    ? void 0
    : node_worker_threads_1.parentPort.on("message", function (data) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    _b.label = 2;
                case 2:
                    (_a = messageMap.get(userID)),
                        (wStream = _a.wStream),
                        (rStream = _a.rStream),
                        (indexFilePath = _a.indexFilePath),
                        (index = _a.index);
                    // build updatedIndex
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    return [
                        4 /*yield*/,
                        _d.sent().readFile({ encoding: "utf-8" }),
                    ];
                case 2:
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [
                                        4 /*yield*/,
                                        createEmptyFile(messageListPath),
                                    ];
                                case 1:
                                    _a.sent();
                                    return [
                                        4 /*yield*/,
                                        writeJSON(messageListPath, []),
                                    ];
                                case 2:
                                    _a.sent();
                                    newlyCreated = true;
                                ...
                                case 5:
                                    for (
                                        _i = 0, messageList_1 = messageList;
                                        _i < messageList_1.length;
                                        _i++
                                    ) {
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [
                        ...
                        writeJSON(
                            messageListPath,
                            Array.from(messageListMap.values()),
                        ),
                    ];
                case 3:
                    _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [
                2 /*return*/,
                new Promise(function (resolve, reject) {
                    createEmptyFile(path).then(function () {
                        return resolve(true);
                    });
                }),
            ];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    return [4 /*yield*/, fsP.open(path, "w")];
                case 3:
                    _a.sent().close();
...
function handleFsError(error) {
    ...
    node_worker_threads_1.parentPort === void 0
        ? void 0
        : node_worker_threads_1.parentPort.emit("messageerror", error);
}
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (!fs.existsSync(inputFilePath))
                        throw new Error(
                            "File ".concat(inputFilePath, " does not exist."),
                        );
                    return [
                        4 /*yield*/,
                        Promise.all([
                ...
                case 2:
                    ...
                    return [
                        4 /*yield*/,
                        readPreviousChar(stat, file, chars, encoding),
                    ];
                case 3:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        fsP.readFile(file, { encoding: "utf-8" }),
                    ];
                case 1:
                    jsonString = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        fsP.writeFile(file, JSON.stringify(object)),
                    ];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
