...
export class Cos {
     ...
     */
    public async putImages(
        image: File[],
        loadingCallBack?: (percent: number, speed: number) => void,
        finishCallBack?: (ok: boolean) => void,
    ): Promise<string[]>;
    public async putImages(
        image: File,
        loadingCallBack?: (percent: number, speed: number) => void,
...
export class CredentialGenerator {
    ...
    private getCredentialFromStorage(): CredentialData | null {
        ...
        return credentialString
            ? (JSON.parse(credentialString) as CredentialData)
            : null;
    }
